    ...
    <CoordonneeStyle>
      <Content>
        <Title>
          ...
          <br />
          <BodyMed>
            Merci de vérifier attentivement l’exactitude de vos informations, vos récompenses seront livrées à l’adresse
        ...
        <CoordoneeForm>
          <Formik
            ...
            validationSchema={Yup.object({
              ...
              codePostal: Yup.string().required('Champs obligatoire'),
              ville: Yup.string().required('Champs obligatoire'),
              pays: Yup.string().required('Champs obligatoire'),
            })}
          ...
          >
            <Form>
              <FormWrapper>
                <MyRadio label="Civilité" fieldName="civilite" name="civilite" data={['Madame', 'Monsieur']} />
                <Flex>
                  <MyTextInput label="Nom" name="lastname" type="text" placeholder="Nom" />
                  <MyTextInput label="Prénom" name="firstname" type="text" placeholder="Prénom" />
                </Flex>
                <Flex>
                  <MyTextInput label="Adresse" name="adresse" type="text" placeholder="Adresse*" />
                  <MyTextInput label="Code postal" name="codePostal" type="text" placeholder="Code postal*" />
                </Flex>
                <Flex>
                  <MyTextInput label="Ville" name="ville" type="text" placeholder="Ville*" />
                  <MyTextInput label="Pays" name="pays" type="text" placeholder="Pays*" />
                </Flex>
                <Account>
                  <BodyMed>
                    Renseignez votre RIB si vous souhaitez recevoir votre récompense sur votre compte bancaire.
                  </BodyMed>
                </Account>
                <MyTextInput label="Nom Compte" name="nomCompte" type="text" placeholder="Nom Compte*" />
                <MyTextInput label="Iban" name="iban" type="text" placeholder="Iban*" />
                <ButtonPrimary
                  height={'5rem'}
