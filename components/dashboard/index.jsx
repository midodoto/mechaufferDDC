  ...
  return (
    <DashboardStyle>
      <Title>
        {stateMenu === 0 && (
          <>
            ...
            <Body>
              Merci de vérifier attentivement l’exactitude de vos informations, vos récompenses seront livrées à
              l’adresse communiquée ci-dessous.
            </Body>
          </>
        )}
        {stateMenu === 1 && (
      ...
      <Wrapper>
        ...
        <Right>
          {stateMenu === 0 && <TableauDeBord demandes={demandes} getDevisByUserIdFct={getDevisByUserIdFct} />}
          {stateMenu === 1 && <Demandes demandes={demandes} getDevisByUserIdFct={getDevisByUserIdFct} />}
          {stateMenu === 2 && <Recompenses demandes={demandes} getDevisByUserIdFct={getDevisByUserIdFct} />}
          {stateMenu === 3 && <Gestion />}
          {stateMenu === 4 && <Coordonnee />}
        </Right>
      </Wrapper>
      <br />
      <br />
