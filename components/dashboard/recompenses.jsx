...
const Recompenses = ({ demandes }) => {

    return (
        <>
        <RecompensesStyle>

<Title><Body2>Mes prochaines récompenses</Body2></Title>
<Swiper
spaceBetween={50}
slidesPerView={5}
...
<Description><BodyMed fontSize='1.4'>Iphone X(ou 150€)</BodyMed></Description>
</Wrapper>
</SwiperSlide>
<SwiperSlide>
<Wrapper>
...
<Description><BodyMed fontSize='1.4'>Iphone 12(ou 250€)</BodyMed></Description>
</Wrapper>
</SwiperSlide>
<SwiperSlide>
<Wrapper>
...
<Description><BodyMed fontSize='1.4'>Macbook Pro (ou 350€)</BodyMed></Description>
</Wrapper>
</SwiperSlide>
<SwiperSlide>
<Wrapper>
...
<Description><BodyMed fontSize='1.4'>Iphone 14(ou 750€)</BodyMed></Description>
</Wrapper>
</SwiperSlide>
<SwiperSlide>
<Wrapper>
...
<Description><BodyMed fontSize='1.4'>Croisière pour 2 personnes(ou 1500€)</BodyMed></Description>
</Wrapper>
</SwiperSlide>
</Swiper>
<ProgressBar>
...
<Body3>30 XCP</Body3>
        ...
        <DemandesWrapper>
                <Title><Body2>Mes dernières demandes</Body2></Title>
