      ...
      <Wrapper>
        <Step1 display={display === true}>
          ...
          <Body2 color={themeContext.colors.black} className={'subtitle'}>
            Renseignez l’adresse email de votre compte Mechauffer. Vous recevrez un email pour réinitialiser votre mot
            de passe
          </Body2>
        ...
        <Step2 display={display === false}>
          ...
          <Body2 color={themeContext.colors.black} className={'subtitle'}>
            Nous venons de vous envoyer un email afin de réinitialiser votre mot de passe
            <br />
            <br />
            Si vous ne l’avez pas reçu, pensez à vérifier votre dossier “courrier indésirable”
          </Body2>
        </Step2>
      </Wrapper>
    </ForgotPassowrdStyle>
