...
const Body1 = ({ children, color = '', fontSize = '', className = '', lineHeight = '', disable = false }) => (
  <BodyComponent className={className} color={color} fontSize={fontSize} lineHeight={lineHeight} disable={disable}>
    {children}
  </BodyComponent>
);
