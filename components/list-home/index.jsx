      ...
      <ListHomeWrapper>
        <Left>
          <Li>
            ...
            <Body>
              Tous nos partenaires détiennent le label RGE (Reconnu Garant de l’Environnement), une enquête de
              satisfaction est effectuée par nos soins pour chaque réalisation.
            </Body>
          </Li>
          <Li>
            ...
            <Body>
              Toutes nos réalisations sont obligatoirement contrôlées par des organismes accrédités COFRAC par l’état.
            </Body>
          </Li>
          <Li>
            ...
            <Body>
              Un de nos agents vous accompagnera dans vos démarches administratives, ainsi que tout au long de votre
              projet.
            </Body>
          </Li>
          <Li>
            ...
            <Body>
              Que nous faisons notre maximum pour leurs décrocher les meilleurs montants d’aide sur le marché étant
              donné que cela varie selon le partenaire financier
            </Body>
          </Li>
        </Left>
      </ListHomeWrapper>
