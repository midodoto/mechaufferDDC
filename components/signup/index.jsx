        ...
        <SignupForm handleSignupFct={handleSignupFct}>
            <Wrapper handleSignupFct={handleSignupFct}>
                <Step1 display={display === true}>
                    ...
                    <ButtonWrapper>
                        <ButtonPrimary onClick={() => setDisplay(false)} width={"26rem"} bgColor={themeContext.colors.primary} hoverBgColor={themeContext.colors.primary} hoverColor={themeContext.colors.white} disabled={!(firstname && name && civilite && phone)}>Continue</ButtonPrimary>
                    </ButtonWrapper>
                </Step1>
