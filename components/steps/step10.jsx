...
const Step10 = ({ display, setStep }) => {
  ...
  const [value, setValue] = useState({
    title: devisReducer.data && devisReducer.data[9] ? devisReducer.data[9].value : null,
  });
  ...
  return (
    <Step10Style display={display}>
      ...
      <Body2 className={'subtitle'}>
        Le revenu fiscal de référence est utilisé pour calculer les primes au plus juste
      </Body2>
      <CardWrapper>
