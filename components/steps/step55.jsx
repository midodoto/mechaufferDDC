...
const Step55 = ({ display, setStep }) => {
    ...
    return (
        <Step5Style  display={display}>
            ...
            <ButtonWrapper>
                <ButtonPrimary onClick={() => setStep(6)} width={"26rem"} bgColor={themeContext.colors.primary} hoverBgColor={themeContext.colors.primary} hoverColor={themeContext.colors.white} disabled={!value}>Continue</ButtonPrimary>
            </ButtonWrapper>
        </Step5Style>
    );
};
