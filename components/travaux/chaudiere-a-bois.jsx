...
const ChaudiereABoisStyle = styled.div``;
  ...
  return (
    <ChaudiereABoisStyle>
      ...
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'une chaudière à bois</H2>
            <H3>Explication de l'intérêt d’installer une chaudière à bois</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de chaudières à bois et caractéristiques</H2>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>
              Avantages de l’installation d’une chaudière à bois pour la consommation d'énergie et le confort thermique
            </H2>
