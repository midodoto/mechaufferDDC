...
const ChauffeEauSolaireStyle = styled.div``;
...
const ChauffeEauSolaire = () => {
  return (
    <ChauffeEauSolaireStyle>
      <Hero />
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'un chauffe-eau solaire</H2>
            <H3>Explication de l'intérêt d’installer un chauffe-eau solaire</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de chauffe-eau solaires et caractéristiques</H2>
...
export default ChauffeEauSolaire;
