...
const ChauffeEauThermodynamiqueStyle = styled.div``;
...
const ChauffeEauThermodynamique = () => {
  return (
    <ChauffeEauThermodynamiqueStyle>
      <Hero />
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'un chauffe-eau thermodynamique</H2>
            <H3>Explication de l'intérêt d’installer un chauffe-eau thermodynamique</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de chauffe-eau thermodynamiques et caractéristiques</H2>
