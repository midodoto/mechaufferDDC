...
const IsolationDesMursStyle = styled.div``;
...
const IsolationDesMurs = () => {
  return (
    <IsolationDesMursStyle>
      <Hero />
      <Wrapper>
        <Flex>
          <Img>
            <H2>Isolation des murs</H2>
            <H3>Explication de l’interet de l’isolation du sol</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types d'isolants et caractéristiques</H2>
...
export default IsolationDesMurs;
