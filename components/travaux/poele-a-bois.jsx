...
const PoeleABoisStyle = styled.div``;
  ...
  return (
    <PoeleABoisStyle>
      ...
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'un poêle à bois</H2>
            <H3>Explication de l'intérêt d’installer un poêle à bois</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de poele à bois et caractéristiques</H2>
