...
const PompeAirAirStyle = styled.div``;
  ...
  return (
    <PompeAirAirStyle>
      ...
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'une pompe à chaleur air/air</H2>
            <H3>Explication de l'intérêt d’installer une pompe à chaleur air/air</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de pompes à chaleur air/air et caractéristiques</H2>
