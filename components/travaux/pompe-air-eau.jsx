...
const PompeAirEauStyle = styled.div``;
  ...
  return (
    <PompeAirEauStyle>
      ...
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'une pompe à chaleur air/eau</H2>
            <H3>Explication de l'intérêt d’installer une pompe à chaleur air/eau</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de pompes à chaleur air/eau et caractéristiques</H2>
