...
const PompeGeometriqueStyle = styled.div``;
...
const PompeGeometrique = () => {
  return (
    <PompeGeometriqueStyle>
      <Hero />
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'une pompe à chaleur géothermique</H2>
            <H3>Explication de l'intérêt d’installer une pompe à chaleur géothermique</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de pompes à chaleur géothermique et caractéristiques</H2>
...
export default PompeGeometrique;
