...
const VmcNaturelleFluxStyle = styled.div``;
...
const VmcNaturelleFlux = () => {
  return (
    <VmcNaturelleFluxStyle>
      <Hero />
      <Wrapper>
        <Flex>
          <Img>
            <H2>Présence d'une ventilation naturelle</H2>
            <H3>Explication de l'intérêt de ventiler le logement</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de ventilations naturelles et caractéristiques</H2>
...
export default VmcNaturelleFlux;
