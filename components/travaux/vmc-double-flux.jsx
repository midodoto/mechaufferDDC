...
const VmcDoubleFluxStyle = styled.div``;
  ...
  return (
    <VmcDoubleFluxStyle>
      ...
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'une VMC Double Flux</H2>
            <H3>Explication de l'intérêt d’installer une VMC Double Flux</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de VMC Double Flux et caractéristiques</H2>
