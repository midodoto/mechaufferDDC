...
const VmcSimpleFluxStyle = styled.div``;
  ...
  return (
    <VmcSimpleFluxStyle>
      ...
      <Wrapper>
        <Flex>
          <Img>
            <H2>Installation d'une VMC Simple Flux</H2>
            <H3>Explication de l'intérêt d’installer une VMC Simple Flux</H3>
        ...
        <FlexReverse>
          ...
          <Img>
            <H2>Types de VMC Simple Flux et caractéristiques</H2>
